...
def detect():
    ...
    parser.add_argument(     '--model',     help='Path of the object detection model.',     required=False,     default='/home/shakib/WebApp/SmartWeight/app/python/efficientdet_lite0.tflite')
